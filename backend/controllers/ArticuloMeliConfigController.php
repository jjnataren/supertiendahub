...
class ArticuloMeliConfigController extends \yii\web\Controller
{
    public function actionIndex()
    {
        ...
        $dataProvider->query->andWhere(['like', 'key', 'config.meli']);
    ...
    public function actionProof($value) {
        \Yii::$app->response->format = \yii\web\Response::FORMAT_JSON;
        return base64_encode(Yii::$app->getSecurity()->encryptByKey($value, env('SECRET_KEY')));
    }
