...
class ArticuloSearch extends Articulo
{
    ...
    {
        return [
            [['sku', 'descripcion', 'sku_fabricante', 'seccion', 'linea', 'marca', 'serie', 'ultima_modificacion'], 'safe'],
            [[ 'peso', 'alto', 'largo', 'ancho'], 'number'],
            [['almacen', 'disponible', 'id_usuario_modifico', 'id_snap'], 'integer'],
        ];
    }
