...
$this->registerJsFile('@web/js/quantity.from.hub.to.prestashop.js', ['depends' => [\backend\assets\BackendAsset::class]]);
    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <i class="fa fa-th"></i>
                <h3 class="box-title">Cambios de cantidad que se pueden actualizar en
            ...
            <div class="box-body table-responsive">
                <?php
                echo Html::beginTag('table', ['id' => 'hub_quantity_to_ps_table', 'class' => 'table table-striped table-bordered',
                    'style' => 'width:100%']);
                ...
                foreach ($result as $r) {
                    ...
                    echo Html::tag('td', $r['quantity_ps']);
                    echo Html::beginTag('td');
                    echo Html::tag('button', 'Exportar Cantidad', ['class' => 'btn btn-primary export',
            ...
            <div class="box-footer">
                <button type="button" class="btn btn-primary" id="export_all_quanity">
                    Exportar todo.
                </button>
            </div>
        </div>
