            ...
            <div class="box-body" id="wizard">
                ...
                <div class="row">
                    <div class="col-md-11">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="prestashop_table_selection" class="table table-bordered table-hover">
                                    <thead>
                                    <tr>
                                        <th>SKU</th>
                                        <th>Precio</th>
                ...
                <div class="row">
                    <div class="col-md-11">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="prestashop_table_updated" class="table table-bordered table-hover">
                                    <thead>
                                    <tr>
                                        <th>SKU</th>
                                        <th>ID en Prestashop</th>
